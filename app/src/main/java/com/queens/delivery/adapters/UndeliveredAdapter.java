...
public class UndeliveredAdapter extends RecyclerView.Adapter<UndeliveredAdapter.UndeliveredViewHolder> implements Filterable {
    ...
    @NonNull
    @Override
    public UndeliveredViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View layout = LayoutInflater.from(mContext).inflate(R.layout.fragment_undelivered_list,viewGroup,false);
        return new UndeliveredViewHolder(layout);
    }

    @Override
    public void onBindViewHolder(@NonNull UndeliveredViewHolder undeliveredViewHolder, int position) {
