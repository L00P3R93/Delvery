...
public class ExchangeAdapter extends RecyclerView.Adapter<ExchangeAdapter.ExchangeViewHolder> implements Filterable {
    private Context mContext;
    private List<NewsItem> mData;
    private List<NewsItem> mDataFiltered;
    boolean isDark = false;

    public ExchangeAdapter(Context mContext, List<NewsItem> mData, boolean isDark) {
    ...
    public ExchangeAdapter(Context mContext, List<NewsItem> mData) {
        this.mContext = mContext;
        this.mData = mData;
        this.mDataFiltered = mData;
    ...
    public ExchangeViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View layout = LayoutInflater.from(mContext).inflate(R.layout.fragment_exchange_list,viewGroup,false);
        return new ExchangeViewHolder(layout);
    }

    @Override
    public void onBindViewHolder(@NonNull ExchangeViewHolder exchangeViewHolder, int position) {
