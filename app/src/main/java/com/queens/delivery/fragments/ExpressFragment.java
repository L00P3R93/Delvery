...
import com.queens.delivery.adapters.ExpressAdapter;
...
public class ExpressFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String URL_EXPRESS_ORDERS = "https://delivery.queensclassycollections.com/api/member/get_express.php?rider_id=2";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fabSwitcher.setOnClickListener(v -> {
            ...
            eAdapter = new ExpressAdapter(getContext(),mOrders,isDark);
    ...
    private void loadOrders(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_EXPRESS_ORDERS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    eAdapter = new ExpressAdapter(getContext(),mOrders,isDark);
                    eAdapter.setOnItemClickListener(new ExpressAdapter.OnItemClickListener() {
                        @Override
