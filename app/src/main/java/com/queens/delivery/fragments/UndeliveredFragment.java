...
public class UndeliveredFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String URL_UNDELIVERED_ORDERS = "https://delivery.queensclassycollections.com/api/member/get_undelivered.php?rider_id=2";
    ...
    private void loadOrders(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_UNDELIVERED_ORDERS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    uAdapter = new UndeliveredAdapter(getContext(),mData,isDark);
                    uAdapter.setOnItemClickListener(new UndeliveredAdapter.OnItemClickListener() {
                        @Override
